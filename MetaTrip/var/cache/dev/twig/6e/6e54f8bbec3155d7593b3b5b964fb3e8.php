...
class __TwigTemplate_9e85698a88c54b6b3765d8b0d0dfd062 extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/MetaTrip/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
